...
\vspace{1em}
\lstinputlisting[mathescape=true, language=pseudo, label=e, caption={Código C++ de la primer implementación de \textit{Eliminación Gaussiana}.}]{files/src/.code/eg1.pseudo}
